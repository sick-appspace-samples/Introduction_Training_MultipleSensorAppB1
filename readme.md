...
The purpose of this one is to be the second of several in parallel running
SensorApps on one device and interact via a served function with the first one.
